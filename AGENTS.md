# AGENTS.md — AntigravityDocs

## Project Context

This is a **documentation-only** repository for Google Antigravity. It contains curated, community-maintained documentation files in `docs/`.
...
- **Official sources only:** Content must be sourced from antigravity.google, antigravity.im
